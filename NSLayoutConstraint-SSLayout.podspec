#
#  Be sure to run `pod spec lint NSLayoutConstraint-SSLayout.podspec' to ensure this is a
...
This project uses MIT License.
  ...
  s.homepage     = "https://github.com/suruihai/NSLayoutConstraint-SSLayout"
  ...
  s.source       = { :git => "https://github.com/suruihai/NSLayoutConstraint-SSLayout.git", :tag => "#{s.version}" }
